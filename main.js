...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamneto)\n/* harmony export */ });\nfunction initFuncionamneto() {\n  var funcionamento = document.querySelector('[data-semana]');\n  var diaSemanas = funcionamento.dataset.semana.split(',').map(Number);\n  var horarioSemanas = funcionamento.dataset.horario.split(',').map(Number);\n  var dataAgora = new Date();\n  var diaAagora = dataAgora.getDay();\n  var horarioAgora = dataAgora.getHours();\n  var semanaAberta = diaSemanas.indexOf(diaAagora) !== -1;\n  var horarioAberto = horarioAgora >= horarioSemanas[0] && horarioAgora < horarioSemanas[1];\n\n  if (semanaAberta && horarioAberto) {\n    funcionamento.classList.add('aberto');\n  }\n}\n\n//# sourceURL=webpack://animais-eslint/./js/modules/funcionamento.js?");
